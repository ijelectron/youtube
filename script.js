...
// 유튜브 검색 API 엔드포인트
const YOUTUBE_SEARCH_ENDPOINT = `https://www.googleapis.com/youtube/v3/search?key=${API_KEY}&part=snippet&type=video&maxResults=8`;
...
// 24개의 이미지 파일 링크 리스트
const imageLinks = [
    'https://ijelectron.modoo.at/?link=33k5h4x6',
    'https://smartstore.naver.com/ijelectron316'
    // 'https://link3.com',
    // 'https://link4.com',
    // ...
    // 'https://link24.com'
...
async function translateAndSearch(targetLang) {
    ...
    searchYouTube(translatedText, targetLang);  // 번역된 텍스트로 유튜브 검색 수행
}
